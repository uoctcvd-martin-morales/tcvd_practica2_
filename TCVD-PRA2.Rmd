...
Como hemos observado que la situación ha cambiado con los años, siendo muy diferente de la actual, únicamente nos quedaremoscon los datos de los 2 últimos años registrados en el dataset.
...
round(mean(df_japan_result$TradePrice - df_japan_result$EstimateTradePrice)/mean(df_japan_test$TradePrice), 2)
